...
#define __NEW_CIFTI_MAPPABLE_DATA_FILE_DECLARE__
#include "NewCiftiMappableDataFile.h"
#undef __NEW_CIFTI_MAPPABLE_DATA_FILE_DECLARE__
...
/**
 * \class caret::NewCiftiMappableDataFile 
 ...
 *    Type of data file.
 */
NewCiftiMappableDataFile::NewCiftiMappableDataFile(const DataFileTypeEnum::Enum dataFileType)
 ...
 * Destructor.
 */
NewCiftiMappableDataFile::~NewCiftiMappableDataFile()
{
    clearPrivate();
}
 ...
 */
NewCiftiMappableDataFile*
NewCiftiMappableDataFile::newInstanceForCiftiFileTypeAndSurface(const DataFileTypeEnum::Enum ciftiFileType,
                                                             ...
                                                             AString& errorMessageOut)
{
    ...
    NewCiftiMappableDataFile* ciftiMappableFile = NULL;
 ...
 */
void
NewCiftiMappableDataFile::clear()
{
 ...
 */
void
NewCiftiMappableDataFile::clearPrivate()
{
    /*
 ...
 */
bool
NewCiftiMappableDataFile::isEmpty() const
{
 ...
 */
StructureEnum::Enum
NewCiftiMappableDataFile::getStructure() const
{
    /*
 ...
 */
void
NewCiftiMappableDataFile::setStructure(const StructureEnum::Enum /*structure*/)
{
 ...
 */
bool
NewCiftiMappableDataFile::isMappableToSurfaceStructure(const StructureEnum::Enum structure) const
{
    /*
 ...
 */
GiftiMetaData*
NewCiftiMappableDataFile::getFileMetaData()
{
 ...
 */
const GiftiMetaData*
NewCiftiMappableDataFile:: getFileMetaData() const
{
    CaretAssert(m_ciftiFile);
    const CiftiXML& ciftiXML = m_ciftiFile->getCiftiXML();
    return ciftiXML.getFileMetaData();
...
//void NewCiftiMappableDataFile::setPreferOnDiskReading(const bool& prefer)
//{
//    if (prefer)
//    {
 ...
 */
void
NewCiftiMappableDataFile::readFile(const AString& filename) throw (DataFileException)
{
    clear();
 ...
 */
void
NewCiftiMappableDataFile::initializeAfterReading(const AString& filename) throw (DataFileException)
{
    CaretAssert(m_ciftiFile);
    const CiftiXML& ciftiXML = m_ciftiFile->getCiftiXML();
    ...
    CaretAssertMessage(0, "Need to finish implementation");
 ...
 */
void
NewCiftiMappableDataFile::validateAfterFileReading() throw (DataFileException)
{
 ...
 */
void
NewCiftiMappableDataFile::writeFile(const AString& filename) throw (DataFileException)
{
    if (m_ciftiFile == NULL) {
        throw DataFileException(filename
...
// */
//AString
//NewCiftiMappableDataFile::ciftiIndexTypeToName(const IndicesMapToDataType ciftiIndexType)
//{
 ...
 */
bool
NewCiftiMappableDataFile::isSurfaceMappable() const
{
 ...
 */
bool
NewCiftiMappableDataFile::isVolumeMappable() const
{
    return m_containsSurfaceData;
}
 ...
 */
int32_t
NewCiftiMappableDataFile::getNumberOfMaps() const
{
 ...
 */
bool
NewCiftiMappableDataFile::hasMapAttributes() const
{
    switch (m_fileMapDataType) {
        case FILE_MAP_DATA_TYPE_INVALID:
            break;
 ...
 */
AString
NewCiftiMappableDataFile::getMapName(const int32_t mapIndex) const
{
 ...
 */
void
NewCiftiMappableDataFile::setMapName(const int32_t mapIndex,
 ...
 */
const GiftiMetaData*
NewCiftiMappableDataFile::getMapMetaData(const int32_t mapIndex) const
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
 ...
 */
GiftiMetaData*
NewCiftiMappableDataFile::getMapMetaData(const int32_t mapIndex)
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
    return m_mapContent[mapIndex]->m_metadata;
 ...
 */
AString
NewCiftiMappableDataFile::getMapUniqueID(const int32_t mapIndex) const
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
 ...
 */
bool
NewCiftiMappableDataFile::isMappedWithPalette() const
{
 ...
 */
void
    NewCiftiMappableDataFile::getMapData(const int32_t mapIndex,
...
bool NewCiftiMappableDataFile::setMapData(const int32_t mapIndex,
...
void
NewCiftiMappableDataFile::getMatrixRGBA(std::vector<float> &rgba,
...
void
NewCiftiMappableDataFile::getMapDimensions(std::vector<int64_t> &dim) const
{
    CaretAssert(m_ciftiFile);
    dim.clear();
...
NewCiftiMappableDataFile::getMapStatistics(const int32_t mapIndex)
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
...
NewCiftiMappableDataFile::getMapFastStatistics(const int32_t mapIndex)
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
 ...
 */
const Histogram*
NewCiftiMappableDataFile::getMapHistogram(const int32_t mapIndex)
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
 ...
 */
PaletteColorMapping*
NewCiftiMappableDataFile::getMapPaletteColorMapping(const int32_t mapIndex)
{
    CaretAssert(m_ciftiFile);
...
NewCiftiMappableDataFile::getMapPaletteColorMapping(const int32_t mapIndex) const
{
    CaretAssert(m_ciftiFile);
 ...
 */
bool
NewCiftiMappableDataFile::isMappedWithLabelTable() const
{
    switch (m_colorMappingMethod) {
        case COLOR_MAPPING_METHOD_INVALID:
            break;
 ...
 */
GiftiLabelTable*
NewCiftiMappableDataFile::getMapLabelTable(const int32_t mapIndex)
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
    switch (m_colorMappingMethod) {
...
NewCiftiMappableDataFile::getMapLabelTable(const int32_t mapIndex) const
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
    switch (m_colorMappingMethod) {
 ...
 */
void
NewCiftiMappableDataFile::updateScalarColoringForMap(const int32_t mapIndex,
 ...
 */
bool
NewCiftiMappableDataFile::isMapColoringValid(const int32_t mapIndex) const
{
    CaretAssertVectorIndex(m_mapContent,
                           mapIndex);
 ...
 */
void
NewCiftiMappableDataFile::getDimensions(int64_t& dimOut1,
                           int64_t& dimOut2,
                           int64_t& dimOut3,
                           int64_t& dimTimeOut,
 ...
 */
void
NewCiftiMappableDataFile::getDimensions(std::vector<int64_t>& dimsOut) const
{
 ...
 */
const int64_t&
NewCiftiMappableDataFile::getNumberOfComponents() const
{
 ...
 */
void
NewCiftiMappableDataFile::indexToSpace(const float& indexIn1,
 ...
 */
void
NewCiftiMappableDataFile::indexToSpace(const int64_t* indexIn,
                          float* coordOut) const
{
    CaretAssert(m_voxelIndicesToOffset);
 ...
 */
void
NewCiftiMappableDataFile::enclosingVoxel(const float& coordIn1,
 ...
 */
bool
NewCiftiMappableDataFile::indexValid(const int64_t& indexIn1,
 ...
 */
void
NewCiftiMappableDataFile::getVoxelSpaceBoundingBox(BoundingBox& boundingBoxOut) const
{
    CaretAssert(m_voxelIndicesToOffset);
 ...
 */
void
NewCiftiMappableDataFile::getVoxelColorsForSliceInMap(const PaletteFile* paletteFile,
                                                      ...
                                                      uint8_t* rgbaOut) const
{
    ...
    if (isMapColoringValid(mapIndex) == false) {
        NewCiftiMappableDataFile* nonConstThis = const_cast<NewCiftiMappableDataFile*>(this);
 ...
 */
void
NewCiftiMappableDataFile::getVoxelColorInMapForLabelData(const PaletteFile* paletteFile,
 ...
 */
void
NewCiftiMappableDataFile::getVoxelColorInMap(const PaletteFile* paletteFile,
                                          const int64_t indexIn1,
                                const int64_t indexIn2,
                                const int64_t indexIn3,
                                const int64_t mapIndex,
 ...
 */
std::vector<int32_t>
NewCiftiMappableDataFile::getUniqueLabelKeysUsedInMap(const int32_t mapIndex) const
{
...
NewCiftiMappableDataFile::getGroupAndNameHierarchyModel()
{
    CaretAssertMessage(0, "Need to update ClassNameHierarchy when this class names changes back to CiftiMappableDataFile");
...
NewCiftiMappableDataFile::getGroupAndNameHierarchyModel() const
{
    CaretAssertMessage(0, "Need to update ClassNameHierarchy when this class names changes back to CiftiMappableDataFile");
//    CaretAssert(m_classNameHierarchy);
//    
//    m_classNameHierarchy->update(const_cast<NewCiftiMappableDataFile*>(this),
//                                 m_forceUpdateOfGroupAndNameHierarchy);
//    m_forceUpdateOfGroupAndNameHierarchy = false;
 ...
 */
void
NewCiftiMappableDataFile::validateKeysAndLabels() const
{
    /*
 ...
 */
bool
NewCiftiMappableDataFile::getMapSurfaceNodeValue(const int32_t mapIndex,
                                              const StructureEnum::Enum structure,
                                              const int nodeIndex,
                                              const int32_t numberOfNodes,
 ...
 */
bool
NewCiftiMappableDataFile::getSurfaceNodeIdentificationForMaps(const std::vector<int32_t>& mapIndices,
                                                              const StructureEnum::Enum structure,
                                                              const int nodeIndex,
                                                              const int32_t numberOfNodes,
 ...
 */
bool
NewCiftiMappableDataFile::getSeriesDataForSurfaceNode(const StructureEnum::Enum structure,
 ...
 */
bool
NewCiftiMappableDataFile::getSeriesDataForVoxelAtCoordinate(const float xyz[3],
                                                         std::vector<float>& seriesDataOut) const
{
    CaretAssert(m_ciftiFile);
 ...
 */
bool
NewCiftiMappableDataFile::getMapSurfaceNodeColoring(const int32_t mapIndex,
                                                  const StructureEnum::Enum structure,
...
bool
NewCiftiMappableDataFile::getSurfaceDataIndicesForMappingToBrainordinates(const StructureEnum::Enum structure,
 ...
 */
bool
NewCiftiMappableDataFile::getMapVolumeVoxelValue(const int32_t mapIndex,
                                              const float xyz[3],
                                              int64_t ijkOut[3],
                                              float& numericalValueOut,
                                              bool& numericalValueOutValid,
 ...
 */
float
NewCiftiMappableDataFile::getVoxelValue(const float* coordinateIn,
                                   bool* validOut,
                                   const int64_t mapIndex,
                                   const int64_t component) const
{
 ...
 */
float
NewCiftiMappableDataFile::getVoxelValue(const float coordinateX,
 ...
 */
int64_t
NewCiftiMappableDataFile::getMapDataOffsetForVoxelAtCoordinate(const float coordinate[3],
 ...
 */
bool
NewCiftiMappableDataFile::getVolumeVoxelIdentificationForMaps(const std::vector<int32_t>& mapIndices,
                                                           const float xyz[3],
                                                           int64_t ijkOut[3],
                                                           AString& textOut) const
{
...
// */
//bool
//NewCiftiMappableDataFile::getStructureAndNodeIndexFromRowIndex(const int64_t rowIndex,
//                                                                              StructureEnum::Enum& structureOut,
//                                                                              int64_t& nodeIndexOut) const
//{
//    CaretAssert(m_ciftiFile);
//    
//    const int64_t numberOfRows = m_ciftiFile->getNumberOfRows();
//    if ((rowIndex >= 0)
...
// */
//bool
//NewCiftiMappableDataFile::getVoxelIndexAndCoordinateFromRowIndex(const int64_t rowIndex,
//                                                                                int64_t ijkOut[3],
 ...
 */
void
NewCiftiMappableDataFile::clearModified()
{
 ...
 */
bool
NewCiftiMappableDataFile::isModifiedExcludingPaletteColorMapping() const
{
...
NewCiftiMappableDataFile::getMapIntervalUnits() const
{
 ...
 */
void
NewCiftiMappableDataFile::getMapIntervalStartAndStep(float& firstMapUnitsValueOut,
 ...
 */
bool
NewCiftiMappableDataFile::getDataRangeFromAllMaps(float& dataRangeMinimumOut,
 ...
 */
int32_t
NewCiftiMappableDataFile::getMappingSurfaceNumberOfNodes(const StructureEnum::Enum structure) const
{
 ...
 */
void
NewCiftiMappableDataFile::saveFileDataToScene(const SceneAttributes* sceneAttributes,
 ...
 */
void
NewCiftiMappableDataFile::restoreFileDataFromScene(const SceneAttributes* sceneAttributes,
 ...
 */
void
NewCiftiMappableDataFile::addToDataFileContentInformation(DataFileContentInformation& dataFileInformation)
{
    CaretAssert(m_ciftiFile);
 ...
 */
ChartDataCartesian*
NewCiftiMappableDataFile::helpLoadChartDataForSurfaceNodeAverage(const StructureEnum::Enum structure,
 ...
 */
ChartDataCartesian*
NewCiftiMappableDataFile::helpLoadChartDataForVoxelAtCoordinate(const float xyz[3]) throw (DataFileException)
{
    ChartDataCartesian* chartData = NULL;
 ...
 */
ChartDataCartesian*
NewCiftiMappableDataFile::helpLoadChartDataForSurfaceNode(const StructureEnum::Enum structure,
 ...
 */
void
NewCiftiMappableDataFile::setMapDataForSurface(const int32_t mapIndex,
                                                   const StructureEnum::Enum structure,
 ...
 */
bool
NewCiftiMappableDataFile::helpLoadChartDataMatrixForMap(const int32_t mapIndex,
 ...
 *    Index of this map.
 */
NewCiftiMappableDataFile::MapContent::MapContent(CiftiFile* ciftiFile,
    ...
    switch (m_fileMapDataType) {
        ...
        case FILE_MAP_DATA_TYPE_MULTI_MAP:
            switch (ciftiXML.getMappingType(m_mappingDirectionForCiftiXML)) {
                ...
                case CiftiMappingType::SERIES:
                {
                    const CiftiSeriesMap& map = ciftiXML.getSeriesMap(m_mappingDirectionForCiftiXML);
                    CaretAssert(0);
                }
                    break;
            }
 ...
 * Destructor.
 */
NewCiftiMappableDataFile::MapContent::~MapContent()
{
    /**
 ...
 */
void
NewCiftiMappableDataFile::MapContent::clearModified()
{
 ...
 */
bool
NewCiftiMappableDataFile::MapContent::isModified() const
{
...
AString
NewCiftiMappableDataFile::MapContent::getName() const
{
    AString mapName;
...
void
NewCiftiMappableDataFile::MapContent::setName(const AString& name)
{
    if (name == getName()) {
        return;
    }
 ...
 */
void
NewCiftiMappableDataFile::MapContent::invalidateColoring()
{
    m_rgbaValid = false;
}
 ...
 */
void
NewCiftiMappableDataFile::MapContent::updateColoring(const std::vector<float>& data,
                                                     const PaletteFile* paletteFile)
{
    if (data.empty()) {
        return;
