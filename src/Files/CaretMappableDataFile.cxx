 ...
 */
CaretMappableDataFile*
CaretMappableDataFile::getLabelDynamicThresholdFile()
{
    return NULL;
}
...
CaretMappableDataFile::getLabelDynamicThresholdFile() const
{
    return NULL;
}
 ...
 */
bool
CaretMappableDataFile::isLabelDynamicThresholdFileSupported() const
{
    return false;
}
...
CaretMappableDataFile::isMapLabelDynamicThresholdEnabledForAnyMap() const
{
    if (isMappedWithPalette()) {
        if (isLabelDynamicThresholdFileSupported()) {
            ...
            for (int32_t i = 0; i < numMaps; i++) {
                if (getMapPaletteColorMapping(i)->isThresholdDynamicLabelOutlineEnabled()) {
                    return true;
                }
            }
        }
