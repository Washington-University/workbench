#ifndef __CZI_META_FILE_H__
#define __CZI_META_FILE_H__
...
namespace caret {
    ...
    class CziMetaFile : public CaretDataFile, public EventListenerInterface {
    ...
    public:
        ...
        CziMetaFile(const CziMetaFile& obj);
        ...
        const Slice* getSlice(const int32_t sliceIndex) const;
        
        const Slice* getSliceNumber(const int32_t sliceNumber) const;
...
//                                                  const SceneClass* sceneClass) = 0;
    ...
    private:
        void copyHelperCziMetaFile(const CziMetaFile& obj);
...
#ifdef __CZI_META_FILE_DECLARE__
    // <PLACE DECLARATIONS OF STATIC MEMBERS HERE>
#endif // __CZI_META_FILE_DECLARE__

} // namespace
#endif  //__CZI_META_FILE_H__
