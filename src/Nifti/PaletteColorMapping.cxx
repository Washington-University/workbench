 ...
 */
void
PaletteColorMapping::setSelectedPaletteName(const std::string& selectedPaletteName)
{
 ...
 */
void
PaletteColorMapping::setThresholdDataName(const std::string& thresholdDataName)
{
