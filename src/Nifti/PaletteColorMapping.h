...
public:
    ...
    void setSelectedPaletteName(const std::string& selectedPaletteName);
    ...
    void setThresholdDataName(const std::string& thresholdDataName);
