...
namespace caret {
    ...
    protected:
        CommandOperation(const std::string& commandLineSwitch,
    ...
    public:
        ...
        std::string getOperationShortDescription() const;
        
        std::string getCommandLineSwitch() const;
        
        void setParameters(ProgramParameters* parameters);
        
    private:
        /** Short description listing commands purpose */
        std::string operationShortDescription;
        
        /** Switch on command line */
        std::string commandLineSwitch;
