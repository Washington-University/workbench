 ...
 * 
 *     Declare the member:
 *         EnumComboBoxTemplate* m_volumeMprSliceDirectionModeEnumComboBox;
 * 
 *     Declare a slot that is called when user changes selection
 *         private slots:
 *             void volumeMprSliceDirectionModeEnumComboBoxItemActivated();
 * 
...
VolumeMontageSliceOrderModeEnum::getGuiToolTip()
{
    ...
    for (auto e : allEnums) {
        const AString modeName(toGuiName(e)
                               + " ("
                               + toLongGuiName(e)
                               + ") - ");
        switch (e) {
            case NEGATIVE:
                txt.appendWithNewLine("<li> "
                                      + modeName
                                      + "Slices are ordered with a decreasing coordinate starting at the top left");
                break;
            case POSITIVE:
                txt.appendWithNewLine("<li> "
                                      + modeName
                                      + "Slices are ordered with an increasing coordinate starting at the top left");
                break;
            case WORKBENCH:
                txt.appendWithNewLine("<li> "
                                      + modeName
