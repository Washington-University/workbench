#ifndef __SURFACE_MONTAGE_CONFIGURATION_HIPPOCAMPUS_FLAT_MAPS_H__
#define __SURFACE_MONTAGE_CONFIGURATION_HIPPOCAMPUS_FLAT_MAPS_H__
...
namespace caret {
    ...
    class SurfaceMontageConfigurationHippocampusFlatMaps : public SurfaceMontageConfigurationAbstract {
        
    public:
        SurfaceMontageConfigurationHippocampusFlatMaps(const int32_t tabIndex);
        
        virtual ~SurfaceMontageConfigurationHippocampusFlatMaps();
    ...
    private:
        SurfaceMontageConfigurationHippocampusFlatMaps(const SurfaceMontageConfigurationHippocampusFlatMaps&);

        SurfaceMontageConfigurationHippocampusFlatMaps& operator=(const SurfaceMontageConfigurationHippocampusFlatMaps&);
...
#ifdef __SURFACE_MONTAGE_CONFIGURATION_HIPPOCAMPUS_FLAT_MAPS_DECLARE__
    // <PLACE DECLARATIONS OF STATIC MEMBERS HERE>
#endif // __SURFACE_MONTAGE_CONFIGURATION_HIPPOCAMPUS_FLAT_MAPS_DECLARE__

} // namespace
#endif  //__SURFACE_MONTAGE_CONFIGURATION_HIPPOCAMPUS_FLAT_MAPS_H__
