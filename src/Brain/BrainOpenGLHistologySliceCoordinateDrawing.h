#ifndef __BRAIN_OPEN_G_L_HISTOLOGY_SLICE_COORDINATE_DRAWING_H__
#define __BRAIN_OPEN_G_L_HISTOLOGY_SLICE_COORDINATE_DRAWING_H__
...
namespace caret {
    ...
    class BrainOpenGLHistologySliceCoordinateDrawing : public CaretObject {
        
    public:
        
        BrainOpenGLHistologySliceCoordinateDrawing();
        
        virtual ~BrainOpenGLHistologySliceCoordinateDrawing();
        ...
        BrainOpenGLHistologySliceCoordinateDrawing(const BrainOpenGLHistologySliceCoordinateDrawing&) = delete;

        BrainOpenGLHistologySliceCoordinateDrawing& operator=(const BrainOpenGLHistologySliceCoordinateDrawing&) = delete;
    ...
    private:
        ...
        Vector3D m_lookAtEyeXYZ;
        
        Vector3D m_lookAtUpXYZ;
        
        Vector3D m_lookAtNormalVector;
        
        Plane m_planeEquation;
...
#ifdef __BRAIN_OPEN_G_L_HISTOLOGY_SLICE_COORDINATE_DRAWING_DECLARE__
    GraphicsTextureMagnificationFilterEnum::Enum BrainOpenGLHistologySliceCoordinateDrawing::s_textureMagnificationFilter = GraphicsTextureMagnificationFilterEnum::LINEAR;
    GraphicsTextureMinificationFilterEnum::Enum  BrainOpenGLHistologySliceCoordinateDrawing::s_textureMinificationFilter  = GraphicsTextureMinificationFilterEnum::LINEAR_MIPMAP_LINEAR;
#endif // __BRAIN_OPEN_G_L_HISTOLOGY_SLICE_COORDINATE_DRAWING_DECLARE__

} // namespace
#endif  //__BRAIN_OPEN_G_L_HISTOLOGY_SLICE_COORDINATE_DRAWING_H__
