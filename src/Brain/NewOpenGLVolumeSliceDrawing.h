#ifndef __NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_H__
#define __NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_H__
...
namespace caret {
    ...
    class NewOpenGLVolumeSliceDrawing : public CaretObject {
        
    public:
        NewOpenGLVolumeSliceDrawing();
        
        virtual ~NewOpenGLVolumeSliceDrawing();
    ...
    private:
        ...
        NewOpenGLVolumeSliceDrawing(const NewOpenGLVolumeSliceDrawing&);

        NewOpenGLVolumeSliceDrawing& operator=(const NewOpenGLVolumeSliceDrawing&);
...
#ifdef __NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_DECLARE__
const int32_t NewOpenGLVolumeSliceDrawing::IDENTIFICATION_INDICES_PER_VOXEL = 5;
#endif // __NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_DECLARE__

} // namespace
#endif  //__NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_H__
