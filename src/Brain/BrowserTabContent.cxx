 ...
 *     Information for drawing the palette colorbars.
 */
void
BrowserTabContent::getPaletteColorBarDrawingInformation(std::vector<const PaletteColorBarDrawingInformation*>& paletteColorBarDrawingInfoOut) 
{
    paletteColorBarDrawingInfoOut.clear();
...
//                                const PaletteColorMapping* paletteColorMapping = mapFile->getMapPaletteColorMapping(mapIndex);
//                                if (paletteColorMapping != NULL) {
//                                    FastStatistics* statistics = NULL;
...
//                                    }
//                                    
//                                    PaletteColorBarDrawingInformation* colorBarInfo = new  PaletteColorBarDrawingInformation(colorBar,
//                                                                                                                statistics,
//                                                                                                                paletteColorMapping);
//                                    paletteColorBarDrawingInfoOut.push_back(colorBarInfo);
//                                }
//                            }
//                        }
//                    }
        ...
        if (info.m_colorBar->isDisplayed()) {
            if (info.m_mapFile != NULL) {
                if (info.m_mapFile->isMappedWithPalette()) {
                    if ((info.m_mapIndex >= 0)
                        && (info.m_mapIndex < info.m_mapFile->getNumberOfMaps())) {
                        const PaletteColorMapping* paletteColorMapping = info.m_mapFile->getMapPaletteColorMapping(info.m_mapIndex);
                        if (paletteColorMapping != NULL) {
                            FastStatistics* statistics = NULL;
                            switch (info.m_mapFile->getPaletteNormalizationMode()) {
                                case PaletteNormalizationModeEnum::NORMALIZATION_ALL_MAP_DATA:
                            ...
                            PaletteColorBarDrawingInformation* colorBarInfo = new  PaletteColorBarDrawingInformation(info.m_colorBar,
                                                                                                                     statistics,
                                                                                                                     paletteColorMapping);
                            paletteColorBarDrawingInfoOut.push_back(colorBarInfo);
                        }
