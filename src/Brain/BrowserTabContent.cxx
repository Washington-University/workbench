...
: TabContentBase()
{
    ...
    m_sceneClassAssistant->add("m_mprRotationZ",
                               &m_mprRotationZ);
    m_sceneClassAssistant->add("m_mprThreeSingleSliceVolumeRotationAngle",
                               &m_mprThreeSingleSliceVolumeRotationAngle);
...
BrowserTabContent::cloneBrowserTabContent(BrowserTabContent* tabToClone)
{
    ...
    *m_obliqueVolumeRotationMatrix = *tabToClone->m_obliqueVolumeRotationMatrix;
    ...
    m_mprThreeSingleSliceVolumeRotationAngle = tabToClone->m_mprThreeSingleSliceVolumeRotationAngle;
...
BrowserTabContent::resetMprRotations()
{
    ...
    m_mprThreeSingleSliceVolumeRotationAngle = 0.0;
}
 ...
 */
float
BrowserTabContent::getMprThreeSingleSliceVolumeRotationAngle() const
{
    return m_mprThreeSingleSliceVolumeRotationAngle;
}
...
/**
 * Set the MPR three single slice rotation angles
 * @param angle
 *    New rotation angle
 */
void
BrowserTabContent::setMprThreeSingleSliceVolumeRotationAngle(const float angle)
{
    m_mprThreeSingleSliceVolumeRotationAngle = angle;
}
                                              ...
                                              const VolumeSliceViewPlaneEnum::Enum sliceViewPlane)
{
    ...
    const bool singleSliceVolumeViewFlag((vmi != NULL)
                                         ? vmi->isSingleSlice()
                                         : false);
    if (singleSliceVolumeViewFlag) {
        m_mprThreeSingleSliceVolumeRotationAngle += rotationAngleCCW;
    }
    else {
        /*
...
BrowserTabContent::getTransformationsInModelTransform(ModelTransform& modelTransform) const
{
    ...
    modelTransform.setMprThreeSingleSliceRotationAngle(m_mprThreeSingleSliceVolumeRotationAngle);
                                                        ...
                                                        const MprThreeRotationUpdateType mprThreeRotationUpdateType)
{
    ...
    setMprThreeSingleSliceVolumeRotationAngle(modelTransform.getMprThreeSingleSliceRotationAngle());
...
BrowserTabContent::getValidVolumeSliceProjectionTypes(std::vector<VolumeSliceProjectionTypeEnum::Enum>& sliceProjectionTypesOut) const
{
    ...
    if (SessionManager::get()->hasSceneWithMprOld()
        || DeveloperFlagsEnum::isFlag(DeveloperFlagsEnum::DEVELOPER_FLAG_MPR_TWO_ENABLED)) {
...
/**
 * @return Step value for  volume montage slice spacing
 */
float
BrowserTabContent::getVolumeMontageSliceSpacingStepValue() const
{
    return m_volumeSliceSettings->getMontageSliceSpacingStepValue();
}

/**
 * @return Digits right of decimal for volume montage slice spacing
 */
int32_t
BrowserTabContent::getVolumeMontageSliceSpacingDecimals() const
{
    return m_volumeSliceSettings->getMontageSliceSpacingDecimals();
}
        ...
        if (btc != this) {
            if (btc->getBrainModelYokingGroup() == m_brainModelYokingGroup) {
                ...
                *m_clippingPlaneGroup = *btc->m_clippingPlaneGroup;
                ...
                m_mprThreeSingleSliceVolumeRotationAngle = btc->m_mprThreeSingleSliceVolumeRotationAngle;
        ...
        if (btc != this) {
            ...
            if (btc->getBrainModelYokingGroup() == m_brainModelYokingGroup) {
                ...
                *btc->m_clippingPlaneGroup = *m_clippingPlaneGroup;
                ...
                btc->m_mprThreeSingleSliceVolumeRotationAngle = m_mprThreeSingleSliceVolumeRotationAngle;
                /*
