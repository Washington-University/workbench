...
namespace caret {
    ...
    class EventGetModelDisplayControllers : public Event {
        
    public:
        EventGetModelDisplayControllers();
        
        virtual ~EventGetModelDisplayControllers();
    ...
    private:
        EventGetModelDisplayControllers(const EventGetModelDisplayControllers&);
        
        EventGetModelDisplayControllers& operator=(const EventGetModelDisplayControllers&);
