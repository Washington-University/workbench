#ifndef __SELECTION_ITEM_HISTOLOGY_STEREOTAXIC_COORDINATE_H_
#define __SELECTION_ITEM_HISTOLOGY_STEREOTAXIC_COORDINATE_H_
...
namespace caret {
    ...
    class SelectionItemHistologyStereotaxicCoordinate : public SelectionItem {
        
    public:
        SelectionItemHistologyStereotaxicCoordinate();
        
        virtual ~SelectionItemHistologyStereotaxicCoordinate();
    ...
    private:
        SelectionItemHistologyStereotaxicCoordinate(const SelectionItemHistologyStereotaxicCoordinate&);

        SelectionItemHistologyStereotaxicCoordinate& operator=(const SelectionItemHistologyStereotaxicCoordinate&);
...
#ifdef __SELECTION_ITEM_HISTOLOGY_STEREOTAXIC_COORDINATE_DECLARE__
    // <PLACE DECLARATIONS OF STATIC MEMBERS HERE>
#endif // __SELECTION_ITEM_HISTOLOGY_STEREOTAXIC_COORDINATE_DECLARE__

} // namespace
#endif  //__SELECTION_ITEM_HISTOLOGY_STEREOTAXIC_COORDINATE_H_
