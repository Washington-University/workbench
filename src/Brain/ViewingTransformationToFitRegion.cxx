...
/**
 * @return True if histology slice successfully fit into region and output values valid
 * @param translationOut
 *    Output with translation
 * @param zoomOut
 *    Output with zooming
 */
bool
ViewingTransformationToFitRegion::applyToHistologySlice(const GraphicsObjectToWindowTransform* transform,
                                                        Vector3D& translationOut,
                                                        float& zoomOut)
{
    m_modeName = "Mode: Histology Slice";
