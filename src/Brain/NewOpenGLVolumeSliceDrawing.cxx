...
#define __NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_DECLARE__
#include "NewOpenGLVolumeSliceDrawing.h"
#undef __NEW_OPEN_G_L_VOLUME_SLICE_DRAWING_DECLARE__
...
/**
 * \class caret::NewOpenGLVolumeSliceDrawing 
 ...
 * Constructor.
 */
NewOpenGLVolumeSliceDrawing::NewOpenGLVolumeSliceDrawing()
: CaretObject()
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::draw(BrainOpenGLFixedPipeline* fixedPipelineDrawing,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawVolumeSliceViewPlane(const VolumeSliceDrawingTypeEnum::Enum sliceDrawingType,
                              const VolumeSliceProjectionTypeEnum::Enum sliceProjectionType,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawVolumeSlicesForAllStructuresView(const VolumeSliceProjectionTypeEnum::Enum sliceProjectionType,
                                                                  const int32_t viewport[4])
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawVolumeSliceViewType(const VolumeSliceDrawingTypeEnum::Enum sliceDrawingType,
                                           const VolumeSliceProjectionTypeEnum::Enum sliceProjectionType,
                                           const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
                                           const int32_t viewport[4])
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawVolumeSliceViewTypeMontage(const VolumeSliceDrawingTypeEnum::Enum sliceDrawingType,
                                                            const VolumeSliceProjectionTypeEnum::Enum sliceProjectionType,
                                                  const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
                                                  const int32_t viewport[4])
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::createSlicePlaneEquation(const VolumeSliceProjectionTypeEnum::Enum sliceProjectionType,
                                                      const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
                                                      const float sliceCoordinates[3],
                                                      Plane& planeOut)
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawSurfaceOutline(const Plane& plane)
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawVolumeSliceFoci(const Plane& plane)
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawAxesCrosshairsOrthoAndOblique(const VolumeSliceProjectionTypeEnum::Enum sliceProjectionType,
                                                                 const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
                                                               const float sliceCoordinates[3],
 ...
 */
void
NewOpenGLVolumeSliceDrawing::getAxesColor(const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawSquare(const float size)
{
 ...
 */
bool
NewOpenGLVolumeSliceDrawing::getMinMaxVoxelSpacing(const VolumeMappableInterface* volume,
                                                     float& minSpacingOut,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::setOrthographicProjection(const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::drawOrthogonalSliceVoxels(const VolumeSliceViewPlaneEnum::Enum sliceViewPlane,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::resetIdentification()
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::addVoxelToIdentification(const int32_t volumeIndex,
                                                        const int32_t mapIndex,
 ...
 */
void
NewOpenGLVolumeSliceDrawing::processIdentification()
{
 ...
 */
bool
NewOpenGLVolumeSliceDrawing::getVoxelCoordinateBoundsAndSpacing(float boundsOut[6],
                                                                float spacingOut[3])
{
    const int32_t numberOfVolumesToDraw = static_cast<int32_t>(m_volumeDrawInfo.size());
 ...
 */
void
NewOpenGLVolumeSliceDrawing::createObliqueTransformationMatrix(Matrix4x4& obliqueTransformationMatrixOut)
{
 ...
 */
NewOpenGLVolumeSliceDrawing::VolumeSlice::VolumeSlice(VolumeMappableInterface* volumeMappableInterface,
                                                        const int32_t mapIndex)
{
 ...
 */
int64_t
NewOpenGLVolumeSliceDrawing::VolumeSlice::addValue(const float value)
{
 ...
 */
uint8_t*
NewOpenGLVolumeSliceDrawing::VolumeSlice::getRgbaForValueByIndex(const int64_t indx)
{
 ...
 */
void
NewOpenGLVolumeSliceDrawing::VolumeSlice::allocateColors()
{
 ...
 */
NewOpenGLVolumeSliceDrawing::VoxelToDraw::VoxelToDraw(const float center[3],
 ...
 */
void
NewOpenGLVolumeSliceDrawing::VoxelToDraw::addVolumeValue(const int64_t sliceIndex,
