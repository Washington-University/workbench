...
namespace caret {
    ...
    class IdentificationItemBorderSurface : public IdentificationItem {
        
    public:
        IdentificationItemBorderSurface();
        
        virtual ~IdentificationItemBorderSurface();
    ...
    private:
        ...
        IdentificationItemBorderSurface& operator=(const IdentificationItemBorderSurface&);
