#ifndef __OLD_BRAIN_OPEN_GL_VOLUME_OBLIQUE_SLICE_DRAWING_H__
#define __OLD_BRAIN_OPEN_GL_VOLUME_OBLIQUE_SLICE_DRAWING_H__
...
namespace caret {
    ...
    private:
        ...
        static const double S_EYE_OFFSET_DISTANCE;
        // ADD_NEW_MEMBERS_HERE
    };
    
#ifdef __OLD_BRAIN_OPEN_GL_VOLUME_OBLIQUE_SLICE_DRAWING_DECLARE__
    const int32_t BrainOpenGLVolumeObliqueSliceDrawing::IDENTIFICATION_INDICES_PER_VOXEL = 8;
    const double BrainOpenGLVolumeObliqueSliceDrawing::S_EYE_OFFSET_DISTANCE = 1.0;
    
#endif // __OLD_BRAIN_OPEN_GL_VOLUME_OBLIQUE_SLICE_DRAWING_DECLARE__

} // namespace
#endif  //__OLD_BRAIN_OPEN_GL_VOLUME_OBLIQUE_SLICE_DRAWING_H__
