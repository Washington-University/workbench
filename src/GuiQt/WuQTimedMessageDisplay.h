#ifndef __WU_Q_TIMED_MESSAGE_DISPLAY_H__
#define __WU_Q_TIMED_MESSAGE_DISPLAY_H__
...
namespace caret {
    ...
    class WuQTimedMessageDisplay : public QDialog {
    ...
    private:
        WuQTimedMessageDisplay(const WuQTimedMessageDisplay&);

        WuQTimedMessageDisplay& operator=(const WuQTimedMessageDisplay&);
...
#endif  //__WU_Q_TIMED_MESSAGE_DISPLAY_H__
