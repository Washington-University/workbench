#ifndef __ANNOTATION_CREATE_DIALOG_TWO_H__
#define __ANNOTATION_CREATE_DIALOG_TWO_H__
...
namespace caret {
    ...
    class AnnotationCreateDialogTwo : public WuQDialogModal {
    ...
    public:
        ...
        AnnotationCreateDialogTwo& operator=(const AnnotationCreateDialogTwo&) = delete;
                
        virtual ~AnnotationCreateDialogTwo();
...
#endif  //__ANNOTATION_CREATE_DIALOG_TWO_H__
