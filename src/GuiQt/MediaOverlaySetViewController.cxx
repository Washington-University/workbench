...
#define __MEDIA_OVERLAY_SET_VIEW_CONTROLLER_DECLARE__
#include "MediaOverlaySetViewController.h"
#undef __MEDIA_OVERLAY_SET_VIEW_CONTROLLER_DECLARE__
...
/**
 * \class caret::MediaOverlaySetViewController
 ...
 *    Parent widget.
 */
MediaOverlaySetViewController::MediaOverlaySetViewController(const Qt::Orientation orientation,
...
: QWidget(parent)
{
    ...
    if (orientation == Qt::Horizontal) {
        ...
        gridLayout->setColumnStretch(9, 100);
        ...
        gridLayout->addWidget(allLabel, row, 7, Qt::AlignHCenter);
    ...
    for (int32_t i = 0; i < BrainConstants::MAXIMUM_NUMBER_OF_OVERLAYS; i++) {
        MediaOverlayViewController* ovc = new MediaOverlayViewController(orientation,
                                                               gridLayout,
                                                               browserWindowIndex,
                                                               i,
                                                               parentObjectName,
 ...
 * Destructor.
 */
MediaOverlaySetViewController::~MediaOverlaySetViewController()
{
 ...
 */
MediaOverlaySet*
MediaOverlaySetViewController::getOverlaySet()
{
    MediaOverlaySet* overlaySet = NULL;
    BrowserTabContent* browserTabContent = 
    GuiManager::get()->getBrowserTabContentForBrowserWindow(m_browserWindowIndex, true);
    if (browserTabContent != NULL) {
        overlaySet = browserTabContent->getMediaOverlaySet();
    }
 ...
 */
void 
MediaOverlaySetViewController::updateViewController()
{
    MediaOverlaySet* overlaySet = this->getOverlaySet();
    if (overlaySet == NULL) {
        return;
    }
 ...
 */
void 
MediaOverlaySetViewController::receiveEvent(Event* event)
{
 ...
 */
void 
MediaOverlaySetViewController::processAddOverlayAbove(const int32_t overlayIndex)
{
    MediaOverlaySet* overlaySet = getOverlaySet();
    if (overlaySet != NULL) {
 ...
 */
void 
MediaOverlaySetViewController::processAddOverlayBelow(const int32_t overlayIndex)
{
    MediaOverlaySet* overlaySet = getOverlaySet();
    if (overlaySet != NULL) {
 ...
 */
void 
MediaOverlaySetViewController::processRemoveOverlay(const int32_t overlayIndex)
{
    MediaOverlaySet* overlaySet = getOverlaySet();
    if (overlaySet != NULL) {
 ...
 */
void 
MediaOverlaySetViewController::processMoveOverlayDown(const int32_t overlayIndex)
{
    MediaOverlaySet* overlaySet = getOverlaySet();
    if (overlaySet != NULL) {
 ...
 */
void 
MediaOverlaySetViewController::processMoveOverlayUp(const int32_t overlayIndex)
{
    MediaOverlaySet* overlaySet = getOverlaySet();
    if (overlaySet != NULL) {
 ...
 */
void
MediaOverlaySetViewController::updateColoringAndGraphics()
{
    this->updateViewController();
