...
namespace caret {
    ...
    class AlgorithmCiftiCorrelationGradient : public AbstractAlgorithm
    {
        ...
        int m_numCols;
        bool m_undoFisherInput, m_applyFisher, m_covariance, m_covSqrt;
        ...
        void init(const CiftiFile* input, const bool& undoFisherInput, const bool& applyFisher, const bool& covariance, const bool& covSqrt);
    ...
    public:
        AlgorithmCiftiCorrelationGradient(ProgressObject* myProgObj, const CiftiFile* myCifti, CiftiFile* myCiftiOut,
                                            ...
                                            const float& surfaceExclude = -1.0f, const float& volumeExclude = -1.0f, const bool& covariance = false, const bool& covSqrt = false, const float& memLimitGB = -1.0f);
