...
namespace caret {
    ...
    class AlgorithmCiftiCorrelationGradient : public AbstractAlgorithm
    {
        ...
        int m_numCols;
        bool m_undoFisherInput, m_applyFisher, m_covariance, m_covSqrt, m_covNormRow, m_covNormCol;
        ...
        void init(const CiftiFile* input, const bool& undoFisherInput, const bool& applyFisher, const bool& covariance, const bool& covSqrt, const bool& covNormRow, const bool& covNormCol);
    ...
    public:
        AlgorithmCiftiCorrelationGradient(ProgressObject* myProgObj, const CiftiFile* myCifti, CiftiFile* myCiftiOut,
                                          ...
                                          const bool& covariance = false, const bool& covSqrt = false, const bool& covNormRow = false, const bool& covNormCol = false,
