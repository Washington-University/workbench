...
#define __ALGORITHM_VOLUME_REDUCE_H__
...
namespace caret {
    ...
    class AlgorithmVolumeReduce : public AbstractAlgorithm
    {
    ...
    typedef TemplateAutoOperation<AlgorithmVolumeReduce> AutoAlgorithmVolumeReduce;

}

#endif //__ALGORITHM_VOLUME_REDUCE_H__
