...
#define __GRAPHICS_OPENGL_POLYLINE_QUADS_DECLARE__
#include "GraphicsOpenGLPolylineQuads.h"
#undef __GRAPHICS_OPENGL_POLYLINE_QUADS_DECLARE__
...
/**
 * \class caret::GraphicsOpenGLPolylineQuads 
 ...
 */
GraphicsPrimitive*
GraphicsOpenGLPolylineQuads::convertLinesToPolygons(AString& errorMessageOut)
{
    errorMessageOut.clear();
 ...
 */
bool
GraphicsOpenGLPolylineQuads::performDrawing()
{
    const int32_t numVertices = static_cast<int32_t>(m_inputXYZ.size() / 3);
    if (numVertices < 2) {
 ...
 */
void
GraphicsOpenGLPolylineQuads::saveOpenGLState()
{
 ...
 */
void
GraphicsOpenGLPolylineQuads::restoreOpenGLState()
{
 ...
 */
void
GraphicsOpenGLPolylineQuads::createProjectionMatrix()
{
 ...
 */
void
GraphicsOpenGLPolylineQuads::createWindowCoordinatesFromVertices()
{
 ...
 */
void
GraphicsOpenGLPolylineQuads::convertFromModelToWindowCoordinate(const float modelXYZ[3],
 ...
 */
void
GraphicsOpenGLPolylineQuads::createQuadFromWindowVertices(const int32_t indexOne,
 ...
 */
void
GraphicsOpenGLPolylineQuads::joinQuads()
{
    CaretAssert(m_primitive);
 ...
 */
void
GraphicsOpenGLPolylineQuads::performJoin(const int32_t windowVertexIndexOne,
 ...
 */
void
GraphicsOpenGLPolylineQuads::createMiterJoinVertex(const float v1[3],
                                                 const float v2[3],
 ...
 */
void
GraphicsOpenGLPolylineQuads::addMiterJoinQuads()
{
 ...
 */
void
GraphicsOpenGLPolylineQuads::convertLineSegmentsToQuads()
{
 ...
 */
void
GraphicsOpenGLPolylineQuads::drawQuads()
{
    GLdouble depthRange[2];
    glGetDoublev(GL_DEPTH_RANGE,
                 depthRange);
 ...
 */
AString 
GraphicsOpenGLPolylineQuads::toString() const
{
    return "GraphicsOpenGLPolylineQuads";
}
