#ifndef __COMMAND_CLASS_CREATE_OPERATION_H__
#define __COMMAND_CLASS_CREATE_OPERATION_H__
...
namespace caret {
    ...
    /// Command that creates class files for an operation
    class CommandClassCreateOperation : public CommandClassCreateBase {
        
    public:
        CommandClassCreateOperation();
        
        virtual ~CommandClassCreateOperation();
    ...
    private:
        ...
        CommandClassCreateOperation(const CommandClassCreateOperation&);

        CommandClassCreateOperation& operator=(const CommandClassCreateOperation&);
...
#endif // __COMMAND_CLASS_CREATE_OPERATION_H__
