...
{
    AString helpInfo = ("\n"
                        "Create operation header (.h) and implementation (.cxx) files.\n"
                        "\n"
                        ...
                        "        Name of the operation class.  Must begin with \"Operation\"\n"
                        "    \n"
                        "    command-line-switch\n"
                        "        Command line switch for operation\n"
                        "    \n"
                        "    short-description\n"
                        "        short description within double quotes\n"
                        "    \n"
                        "    -no-parameters\n"
                        "        Optional parameter if operation does not use parameters.\n"
                        "    \n"
                        );
    return helpInfo; 
}
