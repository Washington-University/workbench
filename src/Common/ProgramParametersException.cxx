 ...
 *
 */
ProgramParametersException::ProgramParametersException(const std::string& s)
: CaretException(s)
{
    this->initializeMembersProgramParametersException();
}
 ...
 */
ProgramParametersException::ProgramParametersException(const ProgramParametersException& e)
: CaretException(e)
{
}
...
void
ProgramParametersException::initializeMembersProgramParametersException()
{
}
