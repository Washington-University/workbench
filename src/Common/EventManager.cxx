...
EventManager::sendSimpleEvent(const EventTypeEnum::Enum eventType)
{
    ...
    switch (eventType) {
        ...
        case EventTypeEnum::EVENT_BROWSER_TAB_ROTATE_SURFACE_TO_SHOW_VERTEX:
        ...
        case EventTypeEnum::EVENT_DARK_LIGHT_COLOR_SCHEME_MODE_CHANGED:
        case EventTypeEnum::EVENT_DARK_LIGHT_COLOR_SCHEME_MODE_GET:
