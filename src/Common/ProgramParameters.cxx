 ...
 */
void
ProgramParameters::addParameter(const std::string& p)
{
 ...
 */
std::string
ProgramParameters::nextString(const std::string& parameterName)
            throw (ProgramParametersException)
{
    ...
    std::string s = this->parameters[this->parameterIndex];
    this->parameterIndex++;
 ...
 */
bool
ProgramParameters::nextBoolean(const std::string& parameterName)
            throw (ProgramParametersException)
{
    std::string s = this->nextString(parameterName);
    bool b = StringUtilities::toBool(s);
    return b;
 ...
 */
int32_t
ProgramParameters::nextInt(const std::string& parameterName)
            throw (ProgramParametersException)
{
    std::string s = this->nextString(parameterName);
    int32_t i = StringUtilities::toInt(s);
    return i;
}
 ...
 */
int64_t
ProgramParameters::nextLong(const std::string& parameterName)
            throw (ProgramParametersException)
{
    std::string s = this->nextString(parameterName);
    int64_t i = StringUtilities::toLong(s);
    return i;
}
 ...
 */
float
ProgramParameters::nextFloat(const std::string& parameterName)
            throw (ProgramParametersException)
{
    std::string s = this->nextString(parameterName);
    float f = StringUtilities::toFloat(s);
    return f;
}
 ...
 */
double
ProgramParameters::nextDouble(const std::string& parameterName)
            throw (ProgramParametersException)
{
    std::string s = this->nextString(parameterName);
    double d = StringUtilities::toFloat(s);
    return d;
}
