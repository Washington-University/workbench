 ...
 * Destructor.
 */
EventLoadSurfaceFile::~EventLoadSurfaceFile()
{
    
}

/**
 * Get the name of the surface file that is to be loaded.
 *
 * @return Name of surface file to load.
 */
AString 
EventLoadSurfaceFile::getSurfaceFileName() const
{
