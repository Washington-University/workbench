...
#
BUILD_DIR=/cygdrive/c/dev/windows64
cd ${BUILD_DIR}
...
rm -f ${ERROR_FILE}
echo "Windows64 Build Result" > ${ERROR_FILE}
...
cd caret5_source
DIST_DIR=caret@hippocampus:/Volumes/DS4600/caret_distribution/caret/bin_windows64
...
#
cat ${ERROR_FILE} | email -n caret -f 'caret@jonsdev-win.wustl.edu' -s 'Windows 64 Build Result' john@brainvis.wustl.edu,jschindl@brainvis.wustl.edu,tsc5yc@mst.edu
