...
#
BUILD_DIR=/cygdrive/c/dev7/windows64
cd ${BUILD_DIR}
...
#
ERROR_FILE=${BUILD_DIR}/result_build_windows64.txt
rm -f ${ERROR_FILE}
echo "Caret7 Windows64 Build Result" > ${ERROR_FILE}
...
scp -v build/CommandLine/caret_command.exe $DIST_DIR >> ${ERROR_FILE} 2>&1
...
#
cat ${ERROR_FILE} | email -n caret -f 'caret@jonsdev-win.wustl.edu' -s 'Caret7 Windows 64 Build Result' john@brainvis.wustl.edu,jschindl@brainvis.wustl.edu,tsc5yc@mst.edu
