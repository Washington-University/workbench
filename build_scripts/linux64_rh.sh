...
#cat ${ERROR_FILE} | mail -v -s 'Caret7 Linux 64 Intel Build Result' john@brainvis.wustl.edu jschindl@brainvis.wustl.edu tsc5yc@mst.edu >> ${MAIL_ERROR_FILE} 2>&1
cat ${ERROR_FILE} | mail -v -s 'Caret7 Linux 64 Intel Build Result' jschindl@brainvis.wustl.edu >> ${MAIL_ERROR_FILE} 2>&1
echo "Sent mail"
