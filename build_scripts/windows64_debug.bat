...
REM c:\cygwin\bin\scp build/Desktop/workbench.exe %DIST_DIR%
REM c:\cygwin\bin\scp build/CommandLine/wb_command.exe %DIST_DIR%
REM echo "Finished Copying Files"
